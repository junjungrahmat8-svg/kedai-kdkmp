...
<body class="antialiased">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-16">
                <div class="flex items-center gap-2">
                    <span class="text-2xl font-black tracking-wider text-white">KD<span class="text-slate-200">KMP</span></span>
                    <span class="text-xs border-l border-white/30 pl-2 hidden sm:inline text-slate-200">Kedai Sembako Indonesia</span>
                </div>
                <div class="hidden md:flex space-x-6 font-medium text-sm">
                    <a href="#" class="hover:text-slate-200 transition">Beranda</a>
                    <a href="#katalog" class="hover:text-slate-200 transition">Katalog Sembako</a>
                </div>
                <div>
                    <a href="#katalog" class="bg-white text-kdkmp-red px-4 py-2 rounded-lg font-bold hover:bg-slate-100 transition text-sm shadow-sm">
                        Belanja Sekarang
                    </a>
                </div>
            </div>
    ...
    <header class="bg-gradient-to-b from-kdkmp-red to-kdkmp-crimson text-white py-20 px-4 relative overflow-hidden shadow-inner">
        <div class="max-w-5xl mx-auto text-center relative z-10">
            <span class="bg-white/20 text-white backdrop-blur-sm font-semibold px-3 py-1 rounded-full text-xs uppercase tracking-wider border border-white/20">
                Pemberdayaan Produk Lokal Warga
            </span>
            <h1 class="text-4xl md:text-5xl font-extrabold mt-5 mb-6 leading-tight tracking-tight">
                Dari Nusantara untuk Keluarga, <br class="hidden md:inline"> Belanja Hemat Kualitas Hebat
            </h1>
            <p class="text-red-100 max-w-2xl mx-auto mb-8 text-base md:text-lg font-light">
                Kedai KDKMP mendistribusikan bahan pokok berkualitas secara adil demi mendukung ketahanan pangan lokal masyarakat Indonesia.
            </p>
            <div class="flex justify-center gap-4">
                <a href="#katalog" class="bg-white text-kdkmp-red font-bold px-6 py-3 rounded-lg hover:bg-slate-100 transition shadow-lg">
                    Lihat Katalog
                </a>
            </div>
        </div>
    ...
    <main id="katalog" class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div class="flex flex-col md:flex-row md:items-end justify-between mb-10 gap-4 border-b border-slate-200/60 pb-6">
            <div>
                <h2 class="text-3xl font-extrabold text-kdkmp-dark tracking-tight">Katalog Sembako</h2>
            ...
            <div class="flex flex-wrap gap-2 text-sm">
                ...
                <button onclick="filterKategori('minyak')" class="btn-kategori bg-white border border-slate-200 text-slate-600 px-4 py-1.5 rounded-full font-medium hover:border-kdkmp-red hover:text-kdkmp-red transition shadow-sm cursor-pointer">Minyak Goreng</button>
                <button onclick="filterKategori('gula')" class="btn-kategori bg-white border border-slate-200 text-slate-600 px-4 py-1.5 rounded-full font-medium hover:border-kdkmp-red hover:text-kdkmp-red transition shadow-sm cursor-pointer">Gula & Tepung</button>
            </div>
        </div>
        ...
        <div class="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            ...
            <div class="card-produk bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden hover:shadow-md transition duration-300 flex flex-col justify-between" data-kategori="beras">
                <div onclick="bukaDetail('Beras Premium Cianjur 5kg', 'Rp 72.500', 'Beras kualitas premium pilihan nusantara. Bulir utuh, putih alami tanpa pemutih, dan menghasilkan nasi yang pulen dan harum.')" class="cursor-pointer group">
                    <div class="bg-slate-50 h-44 flex items-center justify-center relative text-slate-400 group-hover:scale-102 transition duration-300">
                        ...
                        <span class="absolute top-3 left-3 bg-emerald-600 text-white font-bold text-xxs px-2 py-0.5 rounded-md uppercase tracking-wider shadow-sm">Stok Ready</span>
                    </div>
                    <div class="p-4">
                        <span class="text-xs font-semibold text-kdkmp-red uppercase tracking-wider">Beras Utama</span>
                        <h3 class="font-bold text-kdkmp-dark text-base mt-1 line-clamp-2 group-hover:text-kdkmp-red transition">Beras Premium Cianjur 5kg</h3>
                        <div class="flex items-center gap-1 mt-2 text-kdkmp-amber text-xs">
                            <span>★★★★★</span> <span class="text-slate-400 font-normal ml-1">(4.9)</span>
                        </div>
                    </div>
                </div>
                <div class="p-4 pt-0">
            ...
            <div class="card-produk bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden hover:shadow-md transition duration-300 flex flex-col justify-between" data-kategori="minyak">
                <div onclick="bukaDetail('Minyak Goreng Sawit 2 Liter', 'Rp 34.000', 'Minyak goreng kelapa sawit murni. Diproses dengan 2 kali penyaringan sehingga jernih, mengoreng lebih garing, serta menjaga kesehatan masakan.')" class="cursor-pointer group">
                    ...
                    <div class="p-4">
                        ...
                        <h3 class="font-bold text-kdkmp-dark text-base mt-1 line-clamp-2 group-hover:text-kdkmp-red transition">Minyak Goreng Sawit 2 Liter</h3>
                        <div class="flex items-center gap-1 mt-2 text-kdkmp-amber text-xs">
                            <span>★★★★☆</span> <span class="text-slate-400 font-normal ml-1">(4.7)</span>
                        </div>
                    </div>
                </div>
                <div class="p-4 pt-0">
            ...
            <div class="card-produk bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden hover:shadow-md transition duration-300 flex flex-col justify-between" data-kategori="gula">
                <div onclick="bukaDetail('Gula Pasir Tebu Asli 1kg', 'Rp 16.500', 'Gula kristal putih manis alami yang diekstrak dari tebu pilihan petani lokal. Bersih, higienis, dan tanpa pemanis buatan.')" class="cursor-pointer group">
                    ...
                    <div class="p-4">
                        <span class="text-xs font-semibold text-kdkmp-red uppercase tracking-wider">Gula & Tepung</span>
                        <h3 class="font-bold text-kdkmp-dark text-base mt-1 line-clamp-2 group-hover:text-kdkmp-red transition">Gula Pasir Tebu Asli 1kg</h3>
                        <div class="flex items-center gap-1 mt-2 text-kdkmp-amber text-xs">
                            <span>★★★★★</span> <span class="text-slate-400 font-normal ml-1">(5.0)</span>
                        </div>
                    </div>
                </div>
                <div class="p-4 pt-0">
    ...
    <div id="modalDetail" class="fixed inset-0 bg-kdkmp-dark/60 z-50 flex items-center justify-center p-4 hidden backdrop-blur-sm transition-all duration-300">
        <div class="bg-white rounded-2xl max-w-md w-full overflow-hidden shadow-2xl border border-slate-100 animate-fade-in">
            <div class="bg-slate-50 h-48 flex items-center justify-center text-slate-400 relative">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-16 w-16 opacity-60" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.2" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z" />
                </svg>
                <button onclick="tutupDetail()" class="absolute top-4 right-4 bg-kdkmp-dark/40 text-white rounded-full p-2 hover:bg-kdkmp-dark/60 transition cursor-pointer">
            ...
            <div class="p-6">
                <h3 id="modalNama" class="text-xl font-bold text-kdkmp-dark tracking-tight">Nama Produk</h3>
                <span id="modalHarga" class="text-lg font-extrabold text-kdkmp-red block mt-1">Harga</span>
    ...
    <footer class="bg-kdkmp-dark text-slate-400 mt-24 border-t-4 border-kdkmp-red">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 flex flex-col sm:flex-row items-center justify-between gap-6 text-sm">
            <div>
                <p class="font-extrabold text-white text-base tracking-wide">Kedai Sembako KDKMP</p>
                <p class="mt-1 text-xs text-slate-400">Program Kemandirian Sembako Berbasis Digital Masyarakat.</p>
            </div>
            <div class="text-center sm:text-right text-xs text-slate-500">
                &copy; 2026 Kedai KDKMP. Hak Cipta Dilindungi.
            </div>
        </div>
    </footer>
    ...
    <script>
        function filterKategori(kategori) {
            ...
            if (window.event) {
                window.event.target.classList.add('bg-kdkmp-red', 'text-white', 'font-semibold');
        ...
        function bukaDetail(nama, harga, deskripsi) {
